...
$sheetTitle = 'Certificate appendix';
$objPHPExcel->getActiveSheet()->setTitle($sheetTitle);

// Set document properties
$objPHPExcel->getProperties()->setCreator("HQC")
    ->setLastModifiedBy("HQC")
    ->setTitle("Certificate appendix")
    ->setSubject("Certificate appendix")
    ->setDescription("Certificate appendix created on: " . date("d/m/Y"))
    ->setKeywords("")
...
header('Content-Disposition: attachment;filename="Certificate-appendix.xlsx"');
