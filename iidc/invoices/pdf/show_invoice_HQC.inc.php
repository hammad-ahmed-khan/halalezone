...
if (isset($invoice_items) and (strstr($invoice_items,"\n") or strstr($invoice_items,"\r")))
{
$items =explode("\n",$invoice_items);
$first_page_items = explode("|",$items[0]);
$HQC_Nr=$first_page_items[0];
$issued_at=$first_page_items[1];
$valid_until= str_replace("\n","",$first_page_items[2]);
}
