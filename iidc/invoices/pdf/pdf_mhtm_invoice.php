...
VALUES ('$clid','$company_invoice','$invoiceNr','$service_type','$date','$invoice_items','$invoice_subtotal','$invoice_vat','$invoice_total','$uba','".mysql_real_escape_string($invoice_address)."','$ymd','$month','".mysql_real_escape_string($template)."')");
$invoice_id = mysql_insert_id();
$crtUpdates =  "and (crtNr='".implode("' or crtNr='",$updateCN)."')";
mysql_query("update $tbl[prefix]_hmtm_certificate set invoice_nr='$invoice_nr' where clid='$clid' $crtUpdates");
...
echo "<script>parent.location.href='../index.php?inc=create_mhtm_invoice';</script>";
}
else
{
$pdf->Output();
