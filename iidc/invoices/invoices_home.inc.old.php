...
?>
			...
			<?php
			$service_types = array('batch' => 'Batch Certificate(s)', 'annual' => 'Annual certificate', 'audit' => 'Audit', 'general' => 'Halal Services', 'credit' => 'Credit note', 'recurring' => 'Monthly');
	...
	<h2 style="text-transform:uppercase;text-align:center"><?php echo $service_types[$_GET['show']]; ?></h2>
		...
		<thead>
			<tr class="firstHead">
				...
				<?php if (isset($invoice_actions)) { ?>
					<td colspan="2"><?php echo ($_GET['show'] != 'credit') ? 'Payment' : ''; ?></td><?php echo ($_GET['show'] != 'credit' && isset($invoice_actions)) ? '<td></td>' : ''; ?>
				<?php }; ?>
			</tr>
			<tr id="headerTh">
				<th>Nr</th>
