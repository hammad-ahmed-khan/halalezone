...
<title>Training Request Form - Halal e-Zone</title>
<style>
label {
  ...
  <div class="main-content">
    <div class="main-content-inner">
      <div class="page-content">
        ...
        <h4 class="modal-title" style="margin:30px 0 25px; font-size:28px; text-align:center; font-weight:bold">
      ...
      <form id="frmTraining" class="modern-form">
        ...
        <!-- Modal Footer -->
        <div class="form-footer modern-footer" style="text-align:right;">
