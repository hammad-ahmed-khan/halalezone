...
<div class="modal fade" id="postReplyModal" tabindex="-1" role="dialog" aria-labelledby="notesModalLabel">
    ...
    <div class="col-md-4">
        <div class="form-group">
            <label for="issueType" style="font-weight: bold;">Issue Type: </label>
...
<div class="row">
    <div class="col-md-12 text-right">
        <a href="#" class="btn btn-danger" id="btnClosetTicket" style="display:none;">Close Ticket</a>
    </div>
</div>
<!--
<div class="form-group">
...
$(document).ready(function() {
    ...
    $("#btnClosetTicket").on('click', function() {
    ...
    $('#btnPostReply').on('click', function(e) {
      ...
      var attachments = texts.join(', ');
          ...
          var formData = {
              ticketId: $('#ticketId').val(), // Assuming you have a hidden input field with id 'ticketId' to store ticket ID
