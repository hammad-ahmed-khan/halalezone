<input type="hidden" name="popai_filename" id="popai_filename" value="" />
<input type="hidden" name="popai_signed_filename" id="popai_signed_filename" value="" />
<div class="row">
  <div class="col-sm-6">
  ...
  <?php if($myuser->userdata['isclient'] != "1"):?> 
    <a href="#" class="btn btn-success pull-right btn-complete" data-state="extension" style="width:150px; margin-left:10px;"><span class="fa fa-check"></span> Mark Complete</a> 
    <?php if($myuser->userdata['isclient'] != "2"):?> 
    <a href="" class="btn btn-warning pull-right btn-skip" data-state="extension" style="margin-left: 10px;"><span class="fa fa-fast-forward"></span> Skip Step</a>    
    <?php endif; ?> 
    <?php endif; ?> 
...
<table id="table_popai" class="table table-hover table-striped table-bordered">
  <thead>
...
<div id="modalpopai" class="modal" data-backdrop="static">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">×</button>
        <h4 class="modal-title title-add">Upload Proof of Payment</h4>
      </div>
      <!--modal header-->
            ...
            <div class="col-md-12">
              <div class="row form-group text-left">
                <div style="padding:0 15px;">
                  ...
                  <div id="popai-pdf-dropzone" class="dropzone">
                  ...
                  <br/><br/>
                    ...
                    <input type="file" name="popai-pdf" class="_3eHqh form-control" id="popai-pdf" tabindex="-1" accept="application/pdf"/>
                    </div>  
                </div>
                  <div id="popai-pdf-queue"></div>
                </div>
              </div>
            </div>
          </div>
