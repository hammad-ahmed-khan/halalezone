 <input type="hidden" name="checklist_filename" id="checklist_filename" value="" />
<input type="hidden" name="checklist_signed_filename" id="checklist_signed_filename" value="" />
<div class="row">
  <div class="col-sm-6">
    <h3>Checklist</h3>
  </div>
  ...
  <?php if($myuser->userdata['isclient'] != "1"):?> 
    ...
    <?php endif; ?> 
    <a href="" class="btn btn-danger  pull-right" id="btn-upload"><span class="glyphicon glyphicon-upload"></span> Upload Filled Checklist </a>
    <?php endif; ?> 
  </div>
</div>
...
<table id="table_checklist" class="table table-hover table-striped table-bordered">
  <thead>
...
<div id="modalchecklist" class="modal" data-backdrop="static">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">×</button>
        <h4 class="modal-title title-add">Upload Filled Checklist</h4>
      </div>
      <!--modal header-->
            ...
            <div class="col-md-12">
              <div class="row form-group text-left">
                <div style="padding:0 15px;">
                  ...
                  <div id="checklist-pdf-dropzone" class="dropzone">
                  ...
                  <br/><br/>
                    ...
                    <input type="file" name="checklist-pdf" class="_3eHqh form-control" id="checklist-pdf" tabindex="-1" accept="application/pdf"/>
                    </div>
                </div>
                  <div id="checklist-pdf-queue"></div>
                </div>
              </div>
            </div>
          </div>
