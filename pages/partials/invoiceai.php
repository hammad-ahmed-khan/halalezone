<input type="hidden" name="invoiceai_filename" id="invoiceai_filename" value="" />
<input type="hidden" name="invoiceai_signed_filename" id="invoiceai_signed_filename" value="" />
<div class="row">
  <div class="col-sm-6">
    <h3>Upload invoice for additional items.</h3>
  </div>
  <div class="col-sm-6">
...
<table id="table_invoiceai" class="table table-hover table-striped table-bordered">
  <thead>
...
<div id="modalinvoiceai" class="modal" data-backdrop="static">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">×</button>
        <h4 class="modal-title title-add">Upload invoice for additional items</h4>
      </div>
      <!--modal header-->
            ...
            <div class="col-md-12">
              <div class="row form-group text-left">
                <div style="padding:0 15px;">
                  ...
                  <div id="invoiceai-pdf-dropzone" class="dropzone">
                  ...
                  <br/><br/>
                    ...
                    <input type="file" name="invoiceai-pdf" class="_3eHqh form-control" id="invoiceai-pdf" tabindex="-1" accept="application/pdf"/>
                    </div>  
                </div>
                  <div id="invoiceai-pdf-queue"></div>
                </div>
              </div>
            </div>
          </div>
