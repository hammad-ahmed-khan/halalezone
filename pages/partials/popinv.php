<input type="hidden" name="popinv_filename" id="popinv_filename" value="" />
<input type="hidden" name="popinv_signed_filename" id="popinv_signed_filename" value="" />
<div class="row">
  <div class="col-sm-6">
  ...
  <?php if($myuser->userdata['isclient'] != "1"):?> 
    <a href="#" class="btn btn-success pull-right btn-complete" data-state="declarations" style="width:150px; margin-left:10px;"><span class="fa fa-check"></span> Mark Complete</a> 
...
<table id="table_popinv" class="table table-hover table-striped table-bordered">
  <thead>
...
<div id="modalpopinv" class="modal" data-backdrop="static">
            ...
            <div class="col-md-12">
              <div class="row form-group text-left">
                <div style="padding:0 15px;">
                  ...
                  <div id="popinv-pdf-dropzone" class="dropzone">
                  ...
                  <br/><br/>
                    ...
                    <input type="file" name="popinv-pdf" class="_3eHqh form-control" id="popinv-pdf" tabindex="-1" accept="application/pdf"/>
                    </div>  
                </div>
                  <div id="popinv-pdf-queue"></div>
                </div>
              </div>
            </div>
          </div>
