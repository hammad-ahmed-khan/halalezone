<input type="hidden" name="dm_filename" id="dm_filename" value="" />
<input type="hidden" name="dm_signed_filename" id="dm_signed_filename" value="" />
<div class="row">
  <div class="col-sm-6">
    <h3>Decision Making Report</h3>
  </div>
  <div class="col-sm-6">
  <?php if($myuser->userdata['isclient'] != "1"):?> 
    <a href="#" class="btn btn-success pull-right btn-complete" data-state="pop" style="width:150px; margin-left:10px;"><span class="fa fa-check"></span> Mark Complete</a> 
...
<table id="table_dm" class="table table-hover table-striped table-bordered">
  <thead>
...
<div id="modaldm" class="modal" data-backdrop="static">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">×</button>
        <h4 class="modal-title title-add">Upload Decision Making Report</h4>
      </div>
      <!--modal header-->
            ...
            <div>
              <div class="form-group text-left">
                <div style="padding:0 15px;">
                  ...
                  <div id="dm-pdf-dropzone" class="dropzone">
                  ...
                  <br/><br/>
                    ...
                    <input type="file" name="dm-pdf" class="_3eHqh form-control" id="dm-pdf" tabindex="-1" accept="application/pdf"/>
                    </div>    
                
                </div>
                  <div id="dm-pdf-queue"></div>
                </div>
              </div>
            </div>
          </div>
