<input type="hidden" name="pop_filename" id="pop_filename" value="" />
<input type="hidden" name="pop_signed_filename" id="pop_signed_filename" value="" />
<div class="row">
  <div class="col-sm-6">
  ...
  <?php if($myuser->userdata['isclient'] != "1"):?> 
    <a href="#" class="btn btn-success pull-right btn-complete" data-state="certificate" style="width:150px; margin-left:10px;"><span class="fa fa-check"></span> Mark Complete</a> 
    <?php if($myuser->userdata['isclient'] != "2"):?> 
    <a href="" class="btn btn-warning pull-right btn-skip" data-state="certificate" style="margin-left: 10px;"><span class="fa fa-fast-forward"></span> Skip Step</a>    
    <?php endif; ?> 
...
<table id="table_pop" class="table table-hover table-striped table-bordered">
  <thead>
...
<div id="modalpop" class="modal" data-backdrop="static">
            ...
            <div class="col-md-12">
              <div class="row form-group text-left">
                <div style="padding:0 15px;">
                  ...
                  <div id="pop-pdf-dropzone" class="dropzone">
                  ...
                  <br/><br/>
                    ...
                    <input type="file" name="pop-pdf" class="_3eHqh form-control" id="pop-pdf" tabindex="-1" accept="application/pdf"/>
                    </div>  
                </div>
                  <div id="pop-pdf-queue"></div>
                </div>
              </div>
            </div>
          </div>
