...
try {
    ...
    $filter='WHERE IFNULL(u.name, \'\') <> \'\' AND u.deleted=0';

    $filter .= ' AND company_id='.$myuser->userdata['company_id'].' AND company_admin = 0 ';
   ...
   $sql = 'SELECT u.id, u.name, login, pass,email, prefix, isclient, application, clients, audit, canadmin, u.prodnumber, 
    
    u.contact_person, u.vat, u.industry, u.category, u.ingrednumber, deleted, c.name as company, company_admin,
