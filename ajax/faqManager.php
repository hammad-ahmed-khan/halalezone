...
function get_all_faqs($dbo) {
    $sql = "SELECT 
            ...
            LEFT JOIN faq_tags t ON ft.tag_id = t.tag_id
...
function create_category($dbo, $name, $description = '') {
    $sql = "INSERT INTO faq_categories (name, description) VALUES (?, ?)";
    $stmt = $dbo->prepare($sql);
