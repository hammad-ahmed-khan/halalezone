...
try {
	...
	$Title = 'Invoice for certification fees';
	...
	if ($errors == "") { 
		...
		$hostPath = $config['filesfolder']."/".$config['clientsfolder']."/".$client."/application/invoice/";			
	...
	$user = $stmt->fetch(PDO::FETCH_ASSOC);
		...
		$ownerEmailAddress = "halal.ezone@gmail.com";
					...
					insertActivityLog($idclient, $idapp, $myuser->userdata['id'], $myuser->userdata['name'], 'invoice for certification fees uploaded');
/*
					$state = "popinv";
