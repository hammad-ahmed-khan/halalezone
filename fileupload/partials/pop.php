...
try {
	...
	if ($errors == "") { 
		...
		$hostPath = $config['filesfolder']."/".$config['clientsfolder']."/".$client."/application/pop/";			
	...
	$body['subject'] = "Halal e-Zone - ".$Title;
	$body['header'] = "";
	...
	$ownerEmailAddress = "halal.ezone@gmail.com";
					...
					$body['header'] = "";
					$body['message'] = "<p>Dear Colleague!</p>";
					$body['message'] = "<p>Kindly proceed to issue the Halal certificate for our client <strong>".$user["name"]."</strong> and ensure its prompt upload to the dashboard.</p>";
					$body['message'] = "<p>Thank you for your prompt attention to this matter.</p>";
					$body['message'] .= "<p>Regards,<br/>Halal e-Zone</p>";					
					sendEmailWithAttach($body);
