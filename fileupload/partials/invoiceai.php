...
try {
	...
	$Title = 'Invoice for additional items';
	...
	if ($errors == "") { 
		...
		$hostPath = $config['filesfolder']."/".$config['clientsfolder']."/".$client."/application/invoiceai/";			
	...
	$user = $stmt->fetch(PDO::FETCH_ASSOC);
		...
		$ownerEmailAddress = "halal.ezone@gmail.com";
					...
					insertActivityLog($idclient, $idapp, $myuser->userdata['id'], $myuser->userdata['name'], 'Invoice for additional items uploaded');
	}
