...
try {
	...
	if ($errors == "") { 
		...
		$hostPath = $config['filesfolder']."/".$config['clientsfolder']."/".$client."/application/checklist/";			
	...
	$user = $stmt->fetch(PDO::FETCH_ASSOC);
		...
		$ownerEmailAddress = "halal.ezone@gmail.com";
				...
				insertActivityLog($idclient, $idapp, $myuser->userdata['id'], $myuser->userdata['name'], 'Filled checklist uploaded');
	}
